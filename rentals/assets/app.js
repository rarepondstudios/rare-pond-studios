...
function renderTabs(){
 ...
 /* v19 (Jack): the per-category cursor tint is REMOVED - the cursor stays in the site look on
    rentals (the engine no longer reads --cc at all); category colour lives in the tabline/cards. */
